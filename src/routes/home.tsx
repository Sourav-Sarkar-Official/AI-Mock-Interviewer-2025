    ...
    <div className="flex-col w-full pb-24">
      <Container>
        <div className="my-8">
          ...
          <p className="mt-4 text-sm md:text-base lg:text-lg text-muted-foreground">
        ...
        <div className="w-full mt-4 rounded-xl bg-gray-100 h-[420px] drop-shadow-md overflow-hidden relative">
          ...
          <div className="hidden md:block absolute w-80 bottom-4 right-4 px-4 py-2 rounded-md bg-white/60 backdrop-blur-md">
            ...
            <p className="text-sm text-neutral-500">
              Your Path to Success Starts Here. Generate practice interviews and
              unlock your potential. Take the next step in your career journey,
              across the globe.
            </p>
          </div>
        </div>
      ...
      <Container className="py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
          ...
          <div className="col-span-1 md:col-span-2 gap-8 max-h-96 min-h-96 w-full flex flex-col items-center justify-center text-center">
            <p className="text-center text-muted-foreground border rounded-xl border-green-500 p-4">
